"""Exemple de gestion des événements souris avec python et pygame.
        ...
        while self.running:
            ...
            for event in pg.event.get():
                if event.type == pg.QUIT:
                    ...
                    if event.button == 1:
                        # Si c'est un clic gauche, on déplace le personnage
                        self.mushroom_rect.x, self.mushroom_rect.y = event.pos
